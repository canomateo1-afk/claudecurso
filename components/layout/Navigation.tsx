            ...
            <AnimatePresence>
              {isScrolled && (
                <motion.div
                  ...
                  className="md:hidden"
                >
                  <Button calLink="mateo-cano/aprende-ia" size="sm">
                    {t("bookFreeCall")}
                  </Button>
                </motion.div>
              )}
            </AnimatePresence>
            <Button calLink="mateo-cano/aprende-ia" size="sm" className="hidden md:inline-flex">
              {t("bookFreeCall")}
            </Button>
          </div>
        </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="px-6 py-4 space-y-4">
              ...
              <Button calLink="mateo-cano/aprende-ia" size="sm" className="w-full">
                {t("bookFreeCall")}
              </Button>
            </div>
          </motion.div>
